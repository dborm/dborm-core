...
public class SelectTest extends BaseTest {
    ...
    public void testB10GetEntityCount() {
        int count = dborm.getEntityCount(UserInfo.class);
    ...
    public void testB15GetEntity() {
        ...
        UserInfo user = dborm.getEntity(UserInfo.class, sql, bindArgs);
    ...
    public void testB20GetEntitys() {
        ...
        String[] bindArgs = new String[]{USER_ID};
        List<QsmOption> userList = dborm.getEntities(QsmOption.class, sql, bindArgs);
    ...
    public void testB30GetEntitys() {
        String sql = "SELECT * FROM qsm_option where user_id = ? ";
        String[] bindArgs = new String[]{USER_ID};
        List<QsmOption> userList = dborm.getEntities(new MyMapper(), sql, bindArgs);
        assertEquals(10, userList.size());
    ...
    public void testC10GetCourse() {
        String sql = "SELECT id, user_name, age FROM user_info where user_id = ? ";
