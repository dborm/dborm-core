package org.dborm.core.test.xml;
...
import org.dborm.core.xml.DbormSchemaInit;
...
public class XmlTest extends BaseTest {
    ...
    public void init() {
        ...
        User user = new User();//User类没有添加任何注解,仍然可以操作,是因为用xml（resources/dborm/schema/schema.xml）描述了该类
        user.setId(USER_ID);
        user.setName("Tom");
